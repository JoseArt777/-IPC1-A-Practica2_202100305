...
public class Main {
   ...
   public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            ImageIcon backgroundImage = new ImageIcon("src/images/fondo_principal.jpg"); // Cambia la ruta por la de tu imagen
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            JButton puntuacionButton = new JButton("Puntuaciones");
