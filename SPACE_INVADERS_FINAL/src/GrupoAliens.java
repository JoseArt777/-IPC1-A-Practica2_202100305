...
public class GrupoAliens {
    ...
    private void iniciaTablaAliens() {
        ...
        for(int ligne = 0; ligne < 8; ligne++) {
            for(int colonne = 0; colonne < 5; colonne++) {
                ...
                switch (colonne) {
                    case 0:
                        image1 = "/alienBas1.png";
                        image2 = "/alienBas2.png";
                        break;
                    case 1:
                    case 2:
                        image1 = "/alienMilieu1.png";
                        image2 = "/alienMilieu2.png";
                        break;
                    default:
                        image1 = "/alienHaut1.png";
                        image2 = "/alienHaut2.png";
                        break;
                }
    ...
    private void joueSonAlien() {
        ...
        if(compteur == 0) {
            Audio.playSound("/sonAlien1.wav");
        } else if(compteur == 1) {
            Audio.playSound("/sonAlien2.wav");
        } else if(compteur == 2) {
            Audio.playSound("/sonAlien3.wav");
        } else {
            Audio.playSound("/sonAlien4.wav");
        }
    }
