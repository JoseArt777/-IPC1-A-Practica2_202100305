...
public class Item2 extends Entidad {
    ...
    public Audio musiqueSoucoupe = new Audio("/sonSoucoupePasse.wav");
    public Audio musiqueDestructionSoucoupe = new Audio("/sonDestructionSoucoupe.wav");
    ...
    public Item2() {        
        ...
        super.dy = 0;
        this.strImg1 = "/dolar.png";
        this.strImg2 = "/simbolo-de-dolar.png";
        this.strImg3 = "";
    ...
    private int getRandomYPosition1() {
        ...
        int maxY = (Constantes.ALTURA_VENTANA-Constantes.MARGEN) - Constantes.Y_POS_INI_EXTRA;
